								...
								<li key={product.id} className="flex py-6 mmd:py-10">
									<div className="flex-shrink-0">
										<img
											...
											className="h-24 w-24 rounded-md object-cover object-center mmd:h-48 mmd:w-48"
										/>
									</div>
										...
										<div className="relative pr-9 mmd:grid mmd:grid-cols-2 mmd:gap-x-6 mmd:pr-0">
											...
											<div className="mt-4 mmd:mt-0 mmd:pr-9">
												...
												<select
													...
													className="max-w-full rounded-md border border-gray-300 py-1.5 text-left text-base font-medium leading-5 text-gray-700 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500 mmd:text-sm"
												>
